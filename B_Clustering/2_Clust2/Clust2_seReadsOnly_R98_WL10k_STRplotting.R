...
QUTA_clust2_clumppDir <- 
  "/RAID1/QUTA_TX_RedOaks/Clustering/STRUCTURE/Clust2_seOnly/WL10k/Output/CLUMPAK/Output/mainPipeline/"
...
mtext('Single Reads Only; R98, 10,000 loci; Second STRUCTURE Run', line=-2.6)
