...
# This is an exploratory script, for checking out the number of loci that are 
# distinct between replicate samples. This is done for different subsets of the data.

library(adegenet)
QUTA_TRO_SE_wd <- '/RAID1/QUTA_TX_RedOaks/Genotyping/SNP_Calling/Output/All_seReadsOnly/'

# %%% R97 DATASET ----
# Read in genepop file for All samples (167), single-end data only, R97
R97_genind <- read.genepop(paste0(QUTA_TRO_SE_wd,"pop_R97/populations.snps.gen"))
...
# %%% R98 DATASET ----
# Read in genepop file for All samples (167), single-end data only, R98
R98_genind <- read.genepop(paste0(QUTA_TRO_SE_wd,"pop_R98/populations.snps.gen"))
# Duplicates: SYST-MOR-0007278 and SYST-MOR-0007278rpt
