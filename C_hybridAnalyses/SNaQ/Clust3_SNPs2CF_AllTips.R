# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# %%% QUTA & TEXAS RED OAKS : SNPS2CF SCRIPT: ALL POSSIBLE TIPS %%%
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
# the "base phylogenetic network", but then also all "tardifolia" individuals. This results CF table is used 
# in downstream analyses, to test different hypotheses as to the positioning of tardifolia individuals.
