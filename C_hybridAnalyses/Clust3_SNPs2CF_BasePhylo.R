# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
# %%% QUTA & TEXAS RED OAKS : SNPS2CF SCRIPT: BASE PHYLOGENETIC NETWORK %%%
# %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
# This script is used to build the "base phylogenetic network" CF table: the table which is built using
# a VCF file of the least admixed individuals in the sample set of the Quercus tardifola Texas Red Oak Clust3
# dataset. It includes 8 samples, none of which are tardifolia.
