...
2. [`Clustering`](https://github.com/HobanLab/QUTA_TRO/tree/main/B_Clustering) contains the scripts used to run STRUCTURE, build neighbor-joining trees, and perform discriminant analysis of principal components. This folder is divided into subfolders
...
3. [`hybridAnalyses`](https://github.com/HobanLab/QUTA_TRO/tree/main/C_hybridAnalyses) contains the scripts used to validate the hybridization patterns found during the clustering steps. As of right now, this strictly consists of calculation of f3 statistics--
